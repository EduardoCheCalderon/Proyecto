            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="edad" name="edad" placeholder="Ingrese la edad de la mascota (no menor de un año)" value="{{old ('edad')}}" required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="file" class="form-control" id="foto" name="foto" accept="image/*" placeholder="Foto de la mascota" value="{{old ('foto')}}" >
                    </div>
                </div>
                    ...
                    <tbody>
                        @foreach($mascotas as $mascota)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ url('Mascotas/'.$mascota->id.'/Edit.mascotasEdit') }}" class="btn btn-small btn-warning">Editar</a>
                                </td>
                                <td>
